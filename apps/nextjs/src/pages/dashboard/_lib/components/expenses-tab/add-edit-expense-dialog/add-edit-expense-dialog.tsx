...
import { CURRENCIES } from "$/server/api/routers/recurrent-debts/mutations/input";
...
const AddEditExpenseDialog: React.FC<Props> = ({ editingExpense, open, setOpen }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <Dialog.Content>
        <Dialog.Header>
          <Dialog.Title>{isEditing ? "Editar Gasto" : "Agregar Gasto"}</Dialog.Title>
