...
const DesignLayout: FC<Props> = ({ children, showSignOut, mainClassName, ...rest }) => (
  <main
    className={cn("relative isolate h-screen overflow-hidden px-6 pt-14 lg:px-8", mainClassName)}
    {...rest}>
