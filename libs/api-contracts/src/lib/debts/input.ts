...
export const archiveDebtInput = z.object({
  debtId: z.string().uuid(),
});
export type ArchiveDebtInput = z.infer<typeof archiveDebtInput>;

export const getPartnersInput = z.enum(["lender", "borrower"]);
export type GetPartnersInput = z.infer<typeof getPartnersInput>;
